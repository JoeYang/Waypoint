/* wp-icons.jsx — inline Lucide-style icon set (1.5px stroke, currentColor) */
(function () {
  const P = {
    ...
    diamond: <><path d="M12 2l10 10-10 10L2 12z"/><path d="M12 8v4"/><circle cx="12" cy="16" r="0.6" fill="currentColor" stroke="none"/></>,
    ...
    star: <path d="M12 2l2.2 6.6L21 11l-6.8 2.4L12 20l-2.2-6.6L3 11l6.8-2.4z" fill="currentColor" stroke="none"/>,
    rotate: <><path d="M3 2v6h6"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L3 8"/></>,
    ...
    git: <><circle cx="6" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="9" r="2.5"/><path d="M18 11.5a6 6 0 0 1-6 6H8.5M6 8.5v7"/></>,
    play: <path d="M6 4l14 8-14 8z" fill="currentColor" stroke="none"/>,
    pause: <><rect x="6" y="5" width="4" height="14" rx="1" fill="currentColor" stroke="none"/><rect x="14" y="5" width="4" height="14" rx="1" fill="currentColor" stroke="none"/></>,
    flask: <><path d="M9 3h6M10 3v5.5L5 18a2 2 0 0 0 1.8 3h10.4A2 2 0 0 0 19 18l-5-9.5V3"/></>,
  ...
  function Icon({ name, size = 20, className, style, strokeWidth = 1.5 }) {
    const path = P[name];
    if (!path) return null;
    return (
  ...
  function WaypointMark({ size = 24, dot = "#3b4cad", stroke = "#171512" }) {
    return (
      <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
        <path d="M24 5 L43 24 L24 43 L5 24 Z" stroke={stroke} strokeWidth="2.5" strokeLinejoin="round"/>
        <circle cx="24" cy="24" r="4.5" fill={dot}/>
      </svg>
    );
  }
  window.Icon = Icon;
  window.WaypointMark = WaypointMark;
})();
